...
$ECHO $SCP ./releng/download/releases/12.6/* "${SSHUSER}:${DOWNLOAD}/releases/12.6/"
...
$ECHO $SCP ./releng/download/releases/cdt-lsp-3.7/* "${SSHUSER}:${DOWNLOAD}/releases/cdt-lsp-3.7/"
